...
@Created   : 7/16/18 1:20 PM
@Desc      :
This module implements the Vocab class for converting string to id and back
词汇表与id互转的经典代码

Initial embeddings for unknown, padding?
https://datascience.stackexchange.com/questions/32345/initial-embeddings-for-unknown-padding/32420#32420
...
class Vocab:
    ...
    def randomly_init_embeddings(self, embed_dim):
        ...
        for token in [self.pad_token, self.unk_token]:
            ...
            # 对于padding和unknown，不能随机化，要处理成0, why?
            # zero values will not be trained?
