"""
@Project   : CubeGirl
@Module    : intent_nbayes.py
@Author    : Deco [deco@cubee.com]
@Created   : 11/22/17 1:46 AM
@Desc      : 
"""
...
if __name__ == "__main__":
    ...
    nbreg = GaussianNB()
    nbreg.fit(layer_0_train, y_train)
    print('Accuracy of the validation data:',
          nbreg.score(layer_0_test, y_test), '\n')

    predictions = nbreg.predict_proba(layer_0_test).tolist()
