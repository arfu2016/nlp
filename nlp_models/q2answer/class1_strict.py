"""
@Project   : CubeGirl
@Module    : class1_strict.py
@Author    : Deco [deco@cubee.com]
@Created   : 1/12/18 1:08 PM
@Desc      : 


Class2: 1
Class2-1 in class2_general.py

Class3: 1
Class3-1 in class2_general.py

Class4: 1, 2, 3
Class4-1, 2, 3 in class2_general.py


SbvAttHedTree, SbvAttHedTree2, SbvAttHedTree3, SbvAttHedTree4

SbvAttHedTree, SbvAttHedTree2, SbvAttHedTree3, SbvAttHedTree4 in
tpl2_general.py

AttAttHedTree, AttAttHedTree2
AttAttHedTree2 in tpl1_strict.py, AttAttHedTree in tpl2_general.py

SbvHedVob, SbvHedVob2, SbvHedVob3, SbvHedVob4, SbvHedVob5
SbvHedVob3b, SbvHedVob3c, SbvHedVob3d, SbvHedVob3e

SbvHedVob3c, SbvHedVob3d, SbvHedVob3e in tpl1_strict.py, SbvHedVob,
SbvHedVob2, SbvHedVob3, SbvHedVob4, SbvHedVob5,
SbvHedVob3b in tpl2_general.py

SbvHedAttVob
SbvHedAttVob in tpl1_strict.py

SbvHedVobSbvHedVob
SbvHedVobSbvHedVob in tpl2_general.py

AttAttAttSbvHedCmp
AttAttAttSbvHedCmp in tpl1_strict.py

SbvAdvAttSbvHedVob
SbvAdvAttSbvHedVob in tpl1_strict.py
"""
...
from .depy_words_tpl import WordsTpl


class Class1GraphToo(WordsTpl):
    """
...
class Class1Graph2Too(WordsTpl):
    """
    Graph template for questions like "ATT的HED"
    Ex: '吉尼斯世界纪录的最远进球'
    """
...
class Class1Graph3Too(WordsTpl):
    """
    Graph template for questions like "ATT的HED"
...
class Class2Graph1Too(WordsTpl):
    """
...
class Class2Graph2Too(WordsTpl):
    """
    Graph template for questions
...
class Class2Graph3Too(WordsTpl):
    """
    Graph template for questions
    Ex: 哪些球员撕裂过膝盖十字韧带
    """
...
class Class3Graph1Too(WordsTpl):
    """
...
class Class3Graph2Too(WordsTpl):
    """
    Graph template for questions like
    Ex: 河床青训培养过哪些球员
    """
...
class Class3Graph3Too(WordsTpl):
    """
    Graph template for questions like
    Ex: "马拉多纳转会巴塞罗那, 谓语的时间"
    """
...
class Class3Graph4Too(WordsTpl):
    """
    Graph template for questions like
    Ex: 对手意大利处子球过哪些球员
    """
...
class Class4Graph1Too(WordsTpl):
    """
    Graph template for questions like
    Ex: 马拉多纳从哪里转会巴塞罗那
    """
...
class Class4Graph2Too(WordsTpl):
    """
    Graph template for questions like
    Ex: 马拉多纳从博卡青年转会到哪里
    """
...
class Class4Graph3Too(WordsTpl):
    """
    Graph template for questions like
...
class Class5Graph1Too(WordsTpl):
    """
    Graph template for questions like
...
class Class5Graph2Too(WordsTpl):
    """
    Graph template for questions like
